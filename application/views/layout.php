          ...
          <div class="sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li <?php if ($this->uri->segment(1) == 'dashboard' || $this->uri->segment(1) == '') echo 'class="active"'; ?> >
                  <?php echo anchor('dashboard', '<i class="icon-home"></i> Dashboard'); ?>
              </li>
              <li <?php if ($this->uri->segment(1) == 'clients') echo 'class="active"'; ?> >
                  <?php echo anchor('clients/display', '<i class="icon-user"></i> Clients'); ?>
              </li>              
              <li <?php if ($this->uri->segment(1) == 'orders') echo 'class="active"'; ?> >
                  <?php echo anchor('orders/display', '<i class="icon-book"></i> Orders'); ?>
              </li>
              <li class="nav-header"><hr /></li>
              <li <?php if ($this->uri->segment(2) == 'settings') echo 'class="active"'; ?> >
                  <?php echo anchor('page/settings', '<i class="icon-cog"></i> Settings'); ?>
              </li>
              <li <?php if ($this->uri->segment(2) == 'logout') echo 'class="active"'; ?> >
                  <?php echo anchor('page/help', '<i class="icon-question-sign"></i> Help'); ?>
              </li>
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
